...
export class Backend implements backendInterface {
    ...
    async addAnnouncement(arg0: string, arg1: string, arg2: string): Promise<void> {
    ...
    async setLibraryInfo(arg0: LibraryInfo): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setLibraryInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setLibraryResources(arg0: Array<LibraryResource>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setLibraryResources(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
